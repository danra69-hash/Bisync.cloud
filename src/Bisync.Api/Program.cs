...
builder.Services.AddScoped<AccountingScaleService>();
builder.Services.AddScoped<IEInvoiceTransmissionPort, StubMyInvoisTransmissionPort>();
builder.Services.AddScoped<EinvoiceDispatchService>();
