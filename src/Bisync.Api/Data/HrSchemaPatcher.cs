...
/// <summary>Creates core HR tables on the shared Bisync PostgreSQL database when they are missing.</summary>
    ...
    public static async Task ApplyAsync(BisyncDbContext db)
    {
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "EmployeeLevels" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_EmployeeLevels" PRIMARY KEY,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "Employees" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_Employees" PRIMARY KEY,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "LeaveBalances" (
                "EmployeeId" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_LeaveBalances" PRIMARY KEY,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "CompanySettings" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_CompanySettings" PRIMARY KEY,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PublicHolidays" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PublicHolidays" PRIMARY KEY,
                "Name" TEXT NOT NULL,
                "Date" TEXT NOT NULL,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "AttendanceRecords" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_AttendanceRecords" PRIMARY KEY,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "LeaveRequests" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_LeaveRequests" PRIMARY KEY,
                "EmployeeId" INTEGER NOT NULL,
                "Type" TEXT NOT NULL,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "ShiftSchedules" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_ShiftSchedules" PRIMARY KEY,
                "EmployeeId" INTEGER NOT NULL,
                "Date" TEXT NOT NULL,
                "StartTime" TEXT NULL,
                "EndTime" TEXT NULL,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "EducationRecords" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_EducationRecords" PRIMARY KEY,
                "EmployeeId" INTEGER NOT NULL,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PreviousEmployments" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PreviousEmployments" PRIMARY KEY,
                "EmployeeId" INTEGER NOT NULL,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "EmployeeMovements" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_EmployeeMovements" PRIMARY KEY,
                "EmployeeId" INTEGER NOT NULL,
                "Date" TEXT NOT NULL,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PerformanceAppraisals" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PerformanceAppraisals" PRIMARY KEY,
                "EmployeeId" INTEGER NOT NULL,
                "Year" TEXT NOT NULL,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "Divisions" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_Divisions" PRIMARY KEY,
                "Name" TEXT NOT NULL,
                "Code" TEXT NULL
            );
            """);
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "Departments" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_Departments" PRIMARY KEY,
                "Name" TEXT NOT NULL,
