...
public static class SchemaPatcher
{
    ...
    /// <summary>Safe to run after Kestrel is listening (also called from deferred startup).</summary>
    public static async Task EnsurePosFloorPlansTableAsync(BisyncDbContext db)
    {
        ...
        {
            // Best-effort — do not block API startup if the table already exists under a prior shape.
        }
    }
