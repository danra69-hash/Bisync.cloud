...
public static class SchemaPatcher
{
    public static async Task ApplyAsync(BisyncDbContext db)
    {
        ...
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "Companies", "GraphTenantId", "TEXT NOT NULL DEFAULT ''");
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "Companies", "GraphClientId", "TEXT NOT NULL DEFAULT ''");
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "Companies", "GraphClientSecret", "TEXT NOT NULL DEFAULT ''");
        ...
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "AppUsers", "PrivacyPolicyVersion", "TEXT");
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "AppUsers", "AcceptedPrivacyPolicyAt", "TIMESTAMP");
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "AppUsers", "DpaVersion", "TEXT");
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "AppUsers", "AcceptedDpaAt", "TIMESTAMP");
        ...
        await EnsurePosSalesImportTablesAsync(db);
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "ProductBomChanges" (
                "Id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_ProductBomChanges" PRIMARY KEY,
                "ProductId" INTEGER NOT NULL,
                "ProductCode" TEXT NOT NULL DEFAULT '',
                "ProductName" TEXT NOT NULL DEFAULT '',
                "CompanyId" INTEGER NULL,
                "LineKind" TEXT NOT NULL DEFAULT 'recipe',
                "ChangeType" TEXT NOT NULL DEFAULT '',
                "ComponentId" TEXT NOT NULL DEFAULT '',
                "ComponentName" TEXT NOT NULL DEFAULT '',
                "OldComponentId" TEXT NULL,
                "OldComponentName" TEXT NULL,
                "OldComponentUom" TEXT NULL,
                "OldQuantity" REAL NULL,
                "OldUnitPrice" REAL NULL,
                "NewComponentId" TEXT NULL,
                "NewComponentName" TEXT NULL,
                "NewComponentUom" TEXT NULL,
                "NewQuantity" REAL NULL,
                "NewUnitPrice" REAL NULL,
                ...
                CONSTRAINT "FK_ProductBomChanges_Products_ProductId"
                    FOREIGN KEY ("ProductId") REFERENCES "Products" ("Id") ON DELETE CASCADE
            );
            """);
        await TryCreateIndexAsync(db, "IX_ProductBomChanges_ProductId_ChangedAt", "ProductBomChanges", "\"ProductId\", \"ChangedAt\" DESC");
        await TryCreateIndexAsync(db, "IX_ProductBomChanges_CompanyId_ChangedAt", "ProductBomChanges", "\"CompanyId\", \"ChangedAt\" DESC");

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "ProductFieldChanges" (
                "Id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_ProductFieldChanges" PRIMARY KEY,
                "ProductId" INTEGER NOT NULL,
                "ProductCode" TEXT NOT NULL DEFAULT '',
                "ProductName" TEXT NOT NULL DEFAULT '',
                "CompanyId" INTEGER NULL,
                ...
                "ChangedAt" timestamp with time zone NOT NULL DEFAULT NOW(),
                "Note" TEXT NOT NULL DEFAULT '',
                CONSTRAINT "FK_ProductFieldChanges_Products_ProductId"
                    FOREIGN KEY ("ProductId") REFERENCES "Products" ("Id") ON DELETE CASCADE
            );
            """);
        await TryCreateIndexAsync(db, "IX_ProductFieldChanges_ProductId_ChangedAt", "ProductFieldChanges", "\"ProductId\", \"ChangedAt\" DESC");
        await TryCreateIndexAsync(db, "IX_ProductFieldChanges_CompanyId_ChangedAt", "ProductFieldChanges", "\"CompanyId\", \"ChangedAt\" DESC");

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "NutritionLibraryFoods" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_NutritionLibraryFoods" PRIMARY KEY,
                "FdcId" bigint NOT NULL,
                "Source" TEXT NOT NULL DEFAULT '',
                "Description" TEXT NOT NULL DEFAULT '',
                "NormalizedName" TEXT NOT NULL DEFAULT '',
                "NdbNumber" TEXT NULL,
                "EnergyKcal" NUMERIC NOT NULL DEFAULT 0,
                "ProteinG" NUMERIC NOT NULL DEFAULT 0,
                "CarbG" NUMERIC NOT NULL DEFAULT 0,
                "SugarsG" NUMERIC NOT NULL DEFAULT 0,
                "FiberG" NUMERIC NOT NULL DEFAULT 0,
                "FatG" NUMERIC NOT NULL DEFAULT 0,
                "SatFatG" NUMERIC NOT NULL DEFAULT 0,
                "SodiumMg" NUMERIC NOT NULL DEFAULT 0,
                "CholesterolMg" NUMERIC NOT NULL DEFAULT 0,
                "UpdatedAt" timestamp with time zone NOT NULL DEFAULT NOW()
            );
            """);
        await TryCreateUniqueIndexAsync(db, "IX_NutritionLibraryFoods_FdcId", "NutritionLibraryFoods", "FdcId");
        await TryCreateIndexAsync(db, "IX_NutritionLibraryFoods_NormalizedName", "NutritionLibraryFoods", "\"NormalizedName\"");
        await TryCreateIndexAsync(db, "IX_NutritionLibraryFoods_Source", "NutritionLibraryFoods", "\"Source\"");

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "NutritionLibraryMeta" (
                "Id" integer NOT NULL CONSTRAINT "PK_NutritionLibraryMeta" PRIMARY KEY,
                ...
                "ChangedOnLastSync" BOOLEAN NOT NULL DEFAULT FALSE
            );
            """);

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "ProductNutrientEstimates" (
                "ProductId" INTEGER NOT NULL CONSTRAINT "PK_ProductNutrientEstimates" PRIMARY KEY,
                "EnergyKcal" NUMERIC NOT NULL DEFAULT 0,
                "ProteinG" NUMERIC NOT NULL DEFAULT 0,
                "CarbG" NUMERIC NOT NULL DEFAULT 0,
                "SugarsG" NUMERIC NOT NULL DEFAULT 0,
                ...
                "CoverageGrams" NUMERIC NOT NULL DEFAULT 0,
                "DetailsJson" TEXT NOT NULL DEFAULT '[]',
                "LibraryVersion" TEXT NOT NULL DEFAULT '',
                "IsStale" BOOLEAN NOT NULL DEFAULT FALSE,
                "CalculatedAt" timestamp with time zone NOT NULL DEFAULT NOW(),
                CONSTRAINT "FK_ProductNutrientEstimates_Products_ProductId"
                    FOREIGN KEY ("ProductId") REFERENCES "Products" ("Id") ON DELETE CASCADE
            );
            """);
        await TryCreateIndexAsync(db, "IX_ProductNutrientEstimates_LibraryVersion", "ProductNutrientEstimates", "\"LibraryVersion\"");
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PosOpenChecks" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PosOpenChecks" PRIMARY KEY,
                "CompanyId" integer NOT NULL,
                "LocationExternalId" TEXT NOT NULL DEFAULT '',
                "ExternalId" TEXT NOT NULL,
                "CheckNumber" integer NOT NULL DEFAULT 0,
                "Cover" integer NOT NULL DEFAULT 0,
                "Dining" TEXT NOT NULL DEFAULT 'dine-in',
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PosClosedChecks" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PosClosedChecks" PRIMARY KEY,
                "CompanyId" integer NOT NULL,
                "LocationExternalId" TEXT NOT NULL DEFAULT '',
                "ExternalId" TEXT NOT NULL,
                "CheckNumber" integer NOT NULL DEFAULT 0,
                "CheckLabel" TEXT NOT NULL DEFAULT '',
                "Covers" integer NOT NULL DEFAULT 0,
                "DiscountCents" bigint NOT NULL DEFAULT 0,
                "TaxCents" bigint NOT NULL DEFAULT 0,
                "VoidCents" bigint NOT NULL DEFAULT 0,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PosPayments" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PosPayments" PRIMARY KEY,
                "CompanyId" integer NOT NULL,
                "LocationExternalId" TEXT NOT NULL DEFAULT '',
                "ExternalId" TEXT NOT NULL,
                "CheckNumber" integer NOT NULL DEFAULT 0,
                ...
                "CardIin" TEXT NOT NULL DEFAULT '',
                "CardIssuer" TEXT NOT NULL DEFAULT '',
                "CardLast4" TEXT NOT NULL DEFAULT '',
                "CardMii" TEXT NOT NULL DEFAULT '',
                "CardMiiLabel" TEXT NOT NULL DEFAULT ''
            );
            """);

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PosVoids" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PosVoids" PRIMARY KEY,
                "CompanyId" integer NOT NULL,
                "LocationExternalId" TEXT NOT NULL DEFAULT '',
                "ExternalId" TEXT NOT NULL,
                "CheckNumber" integer NOT NULL DEFAULT 0,
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PosEodSessions" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PosEodSessions" PRIMARY KEY,
                "CompanyId" integer NOT NULL,
                "LocationExternalId" TEXT NOT NULL DEFAULT '',
                "ExternalId" TEXT NOT NULL,
                ...
                "DiscountConfirmed" INTEGER NOT NULL DEFAULT 0,
        ...
        await TryCreateUniqueIndexAsync(db, "IX_PosOpenChecks_ExternalId", "PosOpenChecks", "ExternalId");
        await TryCreateIndexAsync(db, "IX_PosOpenChecks_CompanyId", "PosOpenChecks", "\"CompanyId\"");
        await TryCreateIndexAsync(db, "IX_PosOpenChecks_Company_Location", "PosOpenChecks", "\"CompanyId\", \"LocationExternalId\"");
        await TryCreateUniqueIndexAsync(db, "IX_PosClosedChecks_ExternalId", "PosClosedChecks", "ExternalId");
        await TryCreateIndexAsync(db, "IX_PosClosedChecks_CompanyId", "PosClosedChecks", "\"CompanyId\"");
        await TryCreateIndexAsync(db, "IX_PosClosedChecks_Company_Location_Paid", "PosClosedChecks", "\"CompanyId\", \"LocationExternalId\", \"PaidAt\"");
        await TryCreateUniqueIndexAsync(db, "IX_PosPayments_ExternalId", "PosPayments", "ExternalId");
        await TryCreateIndexAsync(db, "IX_PosPayments_CompanyId", "PosPayments", "\"CompanyId\"");
        ...
        {
            await db.Database.ExecuteSqlRawAsync("""
                CREATE UNIQUE INDEX IF NOT EXISTS "IX_PosEodSessions_Company_Location_Date"
                ON "PosEodSessions" ("CompanyId", "LocationExternalId", "BusinessDate");
                """);
        }
        catch
        {
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "SalesModuleCustomers" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_SalesModuleCustomers" PRIMARY KEY,
                "CompanyId" integer NOT NULL,
                "ExternalId" TEXT NOT NULL,
                "CompanyName" TEXT NOT NULL,
                "BrandsJson" TEXT NOT NULL DEFAULT '[]',
                "ContactsJson" TEXT NOT NULL DEFAULT '[]',
                "Status" TEXT NOT NULL DEFAULT 'Prospect',
                "CreatedAt" timestamp with time zone NOT NULL DEFAULT NOW(),
                "LastContactDate" timestamp with time zone NULL,
                "LastDiscussionBrief" TEXT NOT NULL DEFAULT '',
                "EngagedUserId" integer NOT NULL DEFAULT 0,
                "EngagedUserEmail" TEXT NOT NULL DEFAULT '',
                "EngagedUserName" TEXT NOT NULL DEFAULT '',
                "Active" INTEGER NOT NULL DEFAULT 1
            );
            """);

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "SalesModuleAppointments" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_SalesModuleAppointments" PRIMARY KEY,
                "CompanyId" integer NOT NULL,
                "SalesModuleCustomerId" integer NOT NULL,
                "Title" TEXT NOT NULL DEFAULT '',
        ...
        await TryCreateUniqueIndexAsync(db, "IX_SalesModuleCustomers_ExternalId", "SalesModuleCustomers", "ExternalId");
        await TryCreateIndexAsync(db, "IX_SalesModuleCustomers_CompanyId", "SalesModuleCustomers", "\"CompanyId\"");
        ...
        await db.Database.ExecuteSqlRawAsync("""
            ...
            """);
        await TryCreateIndexAsync(db, "IX_SalesModuleCompanies_Name", "SalesModuleCompanies", "\"Name\"");
        await db.Database.ExecuteSqlRawAsync("""
            ...
            """);
        await TryCreateIndexAsync(db, "IX_SalesModuleCompanyMembers_Member", "SalesModuleCompanyMembers", "\"SalesTeamMemberId\"");
        ...
        await TryCreateIndexAsync(db, "IX_SalesModuleClientUpdates_SalesTeamMemberId", "SalesModuleClientUpdates", "\"SalesTeamMemberId\"");
        ...
        await db.Database.ExecuteSqlRawAsync("""
            ...
            """);
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "DevTeamUsers", "Position", "TEXT NOT NULL DEFAULT ''");
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "DevTeamUsers", "TeamType", "TEXT NOT NULL DEFAULT 'Management'");
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "DevTeamUsers", "AccessJson", "TEXT NOT NULL DEFAULT '{\"tabs\":[\"overview\"]}'");
        await DatabaseSchemaHelper.TryAddColumnAsync(db, "DevTeamUsers", "InviteToken", "TEXT");
    ...
    static async Task EnsurePromotionsTablesAsync(BisyncDbContext db)
    {
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "Promotions" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_Promotions" PRIMARY KEY,
                "CompanyId" INTEGER NOT NULL,
                "Name" TEXT NOT NULL DEFAULT '',
                "DurationMode" TEXT NOT NULL DEFAULT 'byDate',
                "StartDate" date NOT NULL,
                "EndDate" date,
                "PromotionType" TEXT NOT NULL DEFAULT 'discountPercent',
            ...
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE INDEX IF NOT EXISTS "IX_Promotions_CompanyId_Active"
            ON "Promotions" ("CompanyId", "Active");
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE INDEX IF NOT EXISTS "IX_Promotions_CompanyId_StartDate"
            ON "Promotions" ("CompanyId", "StartDate");
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PromotionProducts" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PromotionProducts" PRIMARY KEY,
                ...
                "KnockedDownPrice" NUMERIC,
                CONSTRAINT "FK_PromotionProducts_Promotions_PromotionId"
                    FOREIGN KEY ("PromotionId") REFERENCES "Promotions" ("Id") ON DELETE CASCADE
            );
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE UNIQUE INDEX IF NOT EXISTS "IX_PromotionProducts_PromotionId_ProductId"
            ON "PromotionProducts" ("PromotionId", "ProductId");
            """);
        await db.Database.ExecuteSqlRawAsync("""
    ...
    /// <summary>Uploaded external POS detailed-sales files + saved header maps.</summary>
    public static async Task EnsurePosSalesImportTablesAsync(BisyncDbContext db)
    {
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PosSalesHeaderMaps" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PosSalesHeaderMaps" PRIMARY KEY,
                "CompanyId" integer NOT NULL,
                "HeaderFingerprint" TEXT NOT NULL DEFAULT '',
            ...
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE UNIQUE INDEX IF NOT EXISTS "IX_PosSalesHeaderMaps_Company_Fingerprint"
            ON "PosSalesHeaderMaps" ("CompanyId", "HeaderFingerprint");
            """);

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PosSalesImportBatches" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PosSalesImportBatches" PRIMARY KEY,
                "CompanyId" integer NOT NULL,
                "LocationExternalId" TEXT NOT NULL DEFAULT '',
                "FileName" TEXT NOT NULL DEFAULT '',
                "FileKind" TEXT NOT NULL DEFAULT '',
                "BusinessDate" date NOT NULL,
                "HeaderFingerprint" TEXT NOT NULL DEFAULT '',
            ...
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE INDEX IF NOT EXISTS "IX_PosSalesImportBatches_Company_Date"
            ON "PosSalesImportBatches" ("CompanyId", "BusinessDate");
            """);

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "PosSalesImportLines" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_PosSalesImportLines" PRIMARY KEY,
                "BatchId" integer NOT NULL,
                "CompanyId" integer NOT NULL,
                "LocationExternalId" TEXT NOT NULL DEFAULT '',
                "BusinessDate" date NOT NULL,
                "SaleAt" timestamp with time zone NULL,
                "CheckNumber" TEXT NOT NULL DEFAULT '',
                "ProductCode" TEXT NOT NULL DEFAULT '',
                "ProductName" TEXT NOT NULL DEFAULT '',
                "ResolvedProductId" integer NULL,
                "Quantity" NUMERIC NOT NULL DEFAULT 0,
                "UnitPrice" NUMERIC NOT NULL DEFAULT 0,
            ...
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE INDEX IF NOT EXISTS "IX_PosSalesImportLines_Company_Loc_Date"
            ON "PosSalesImportLines" ("CompanyId", "LocationExternalId", "BusinessDate");
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE INDEX IF NOT EXISTS "IX_PosSalesImportLines_BatchId"
            ON "PosSalesImportLines" ("BatchId");
            """);
    }
    ...
    public static async Task EnsureGlBooksTablesAsync(BisyncDbContext db)
    {
        ...
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "GlOpenItemLines" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_GlOpenItemLines" PRIMARY KEY,
                "CompanyId" INTEGER NOT NULL,
                ...
                "TaxCode" TEXT,
                "ProductRef" TEXT,
                CONSTRAINT "FK_GlOpenItemLines_GlOpenItems_OpenItemId"
                    FOREIGN KEY ("OpenItemId") REFERENCES "GlOpenItems" ("Id") ON DELETE CASCADE
            );
            """);
        await TryCreateUniqueIndexAsync(db, "IX_GlOpenItemLines_Company_Item_Line", "GlOpenItemLines", "\"CompanyId\", \"OpenItemId\", \"LineNo\"");
        ...
        await DatabaseSchemaHelper.EnsureColumnAsync(db, "GlStatutoryReturns", "TransmissionStatus", "TEXT NOT NULL DEFAULT 'not_connected'");
        await DatabaseSchemaHelper.EnsureColumnAsync(db, "GlStatutoryReturns", "TransmissionRef", "TEXT");

        await DatabaseSchemaHelper.EnsureColumnAsync(db, "GlJournalLines", "LocationExternalId", "TEXT");
        await DatabaseSchemaHelper.EnsureColumnAsync(db, "GlJournalLines", "DepartmentId", "INTEGER");
        await DatabaseSchemaHelper.EnsureColumnAsync(db, "GlJournalLines", "PartnerCompanyId", "INTEGER");

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "GlBudgets" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_GlBudgets" PRIMARY KEY,
                "CompanyId" INTEGER NOT NULL,
                "Name" TEXT NOT NULL DEFAULT '',
                "FiscalYear" INTEGER NOT NULL,
                "Currency" TEXT NOT NULL DEFAULT 'MYR',
            ...
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "GlBudgetLines" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_GlBudgetLines" PRIMARY KEY,
                "CompanyId" INTEGER NOT NULL,
                ...
                CONSTRAINT "FK_GlBudgetLines_Budget" FOREIGN KEY ("BudgetId") REFERENCES "GlBudgets" ("Id") ON DELETE CASCADE
            );
            """);
        await TryCreateIndexAsync(db, "IX_GlBudgetLines_Budget_Acct_Period", "GlBudgetLines", "\"BudgetId\", \"AccountId\", \"PeriodNo\"");

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "GlSavedReports" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_GlSavedReports" PRIMARY KEY,
                "CompanyId" INTEGER NOT NULL,
                "Name" TEXT NOT NULL DEFAULT '',
                "Kind" TEXT NOT NULL DEFAULT 'trial_balance',
                "FiltersJson" TEXT NOT NULL DEFAULT '{{}}',
                "CreatedBy" TEXT NOT NULL DEFAULT '',
                "CreatedAt" timestamp with time zone NOT NULL DEFAULT NOW()
            );
            """);
        await TryCreateIndexAsync(db, "IX_GlSavedReports_Company", "GlSavedReports", "\"CompanyId\", \"Kind\"");

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "GlConsolidationGroups" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_GlConsolidationGroups" PRIMARY KEY,
            ...
            """);
        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "GlConsolidationMembers" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_GlConsolidationMembers" PRIMARY KEY,
                "GroupId" INTEGER NOT NULL,
                "MemberCompanyId" INTEGER NOT NULL,
                "OwnershipPercent" NUMERIC(8,4) NOT NULL DEFAULT 100,
                CONSTRAINT "FK_GlConsolMembers_Group" FOREIGN KEY ("GroupId") REFERENCES "GlConsolidationGroups" ("Id") ON DELETE CASCADE
            );
            """);
        await TryCreateUniqueIndexAsync(db, "IX_GlConsolMembers_Group_Member", "GlConsolidationMembers", "\"GroupId\", \"MemberCompanyId\"");

        await db.Database.ExecuteSqlRawAsync("""
            CREATE TABLE IF NOT EXISTS "GlEinvoiceTransmissions" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL CONSTRAINT "PK_GlEinvoiceTransmissions" PRIMARY KEY,
                "CompanyId" INTEGER NOT NULL,
                "Provider" TEXT NOT NULL DEFAULT 'myinvois-stub',
                "DocumentType" TEXT NOT NULL DEFAULT 'invoice',
                "SourceDocKey" TEXT NOT NULL DEFAULT '',
                "OpenItemId" INTEGER,
                "JournalId" INTEGER,
            ...
            """);
        await TryCreateIndexAsync(db, "IX_GlEinvoice_Company_Status", "GlEinvoiceTransmissions", "\"CompanyId\", \"Status\"");
    }
