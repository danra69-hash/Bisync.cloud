...
DROP INDEX IF EXISTS public."IX_SampleRequests_RequestNumber";
DROP INDEX IF EXISTS public."IX_SampleRequests_CompanyId";
...
--
-- Name: SampleRequests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."SampleRequests" (
    "Id" integer NOT NULL,
    "RequestNumber" text DEFAULT ''::text NOT NULL,
    "CompanyId" integer DEFAULT 0 NOT NULL,
    "DateRequested" date DEFAULT CURRENT_DATE NOT NULL,
    "ContactEmployeeId" integer,
    "ContactPersonName" text DEFAULT ''::text NOT NULL,
    "CompanyRequested" text DEFAULT ''::text NOT NULL,
    "CustomerExternalId" text DEFAULT ''::text NOT NULL,
    "CustomerName" text DEFAULT ''::text NOT NULL,
    "IsNewCustomer" boolean DEFAULT false NOT NULL,
    "ProjectScope" text DEFAULT 'new'::text NOT NULL,
    "RequestType" text DEFAULT 'new_submission'::text NOT NULL,
    "ModificationDetails" text DEFAULT ''::text NOT NULL,
    "ProjectName" text DEFAULT ''::text NOT NULL,
    "DeliveryUnit" text DEFAULT ''::text NOT NULL,
    "ExpectedQtyPerYear" numeric DEFAULT 0 NOT NULL,
    "ExpectedPrice" numeric DEFAULT 0 NOT NULL,
    "ExpectedSalesAmountPerYear" numeric DEFAULT 0 NOT NULL,
    "ProductCategory" text DEFAULT ''::text NOT NULL,
    "ProductGroup" text DEFAULT ''::text NOT NULL,
    "ProductSamplesJson" text DEFAULT '[]'::text NOT NULL,
    "WaterSoluble" boolean DEFAULT false NOT NULL,
    "OilSoluble" boolean DEFAULT false NOT NULL,
    "FlavourNatural" boolean DEFAULT false NOT NULL,
    "FlavourNaturalIdentical" boolean DEFAULT false NOT NULL,
    "FlavourArtificial" boolean DEFAULT false NOT NULL,
    "QuantityRequested" numeric DEFAULT 0 NOT NULL,
    "QuantityUom" text DEFAULT ''::text NOT NULL,
    "TargetProducts" text DEFAULT ''::text NOT NULL,
    "GmoStatus" text DEFAULT 'na'::text NOT NULL,
    "AllergenStatus" text DEFAULT 'na'::text NOT NULL,
    "AllergenFreeFromDetail" text DEFAULT ''::text NOT NULL,
    "McpdHvpFreeDetail" text DEFAULT ''::text NOT NULL,
    "HalalCertified" boolean DEFAULT false NOT NULL,
    "HalalCompliantAccepted" boolean DEFAULT false NOT NULL,
    "CountryRdSite" text DEFAULT ''::text NOT NULL,
    "CountryManufacturing" text DEFAULT ''::text NOT NULL,
    "CountryInUse" text DEFAULT ''::text NOT NULL,
    "RegulatoryRequirement" text DEFAULT 'na'::text NOT NULL,
    "RegulatoryRequirementDetail" text DEFAULT ''::text NOT NULL,
    ...
    "CreatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "UpdatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "TemplateType" text DEFAULT 'sample-request-flavours'::text NOT NULL,
    "VendorExternalId" text DEFAULT ''::text NOT NULL,
    "VendorAddress" text DEFAULT ''::text NOT NULL,
    "VendorContactPerson" text DEFAULT ''::text NOT NULL,
    "VendorContactMobile" text DEFAULT ''::text NOT NULL,
    "VendorContactEmail" text DEFAULT ''::text NOT NULL,
    "IngredientComponentId" text DEFAULT ''::text NOT NULL,
    "ProductPolicyTag" text DEFAULT ''::text NOT NULL,
    "VendorAcceptedAt" timestamp with time zone,
    "VendorAcceptedBy" text DEFAULT ''::text NOT NULL
);


--
-- Name: SampleRequests_Id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public."SampleRequests" ALTER COLUMN "Id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public."SampleRequests_Id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Data for Name: SampleRequests; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."SampleRequests" ("Id", "RequestNumber", "CompanyId", "DateRequested", "ContactEmployeeId", "ContactPersonName", "CompanyRequested", "CustomerExternalId", "CustomerName", "IsNewCustomer", "ProjectScope", "RequestType", "ModificationDetails", "ProjectName", "DeliveryUnit", "ExpectedQtyPerYear", "ExpectedPrice", "ExpectedSalesAmountPerYear", "ProductCategory", "ProductGroup", "ProductSamplesJson", "WaterSoluble", "OilSoluble", "FlavourNatural", "FlavourNaturalIdentical", "FlavourArtificial", "QuantityRequested", "QuantityUom", "TargetProducts", "GmoStatus", "AllergenStatus", "AllergenFreeFromDetail", "McpdHvpFreeDetail", "HalalCertified", "HalalCompliantAccepted", "CountryRdSite", "CountryManufacturing", "CountryInUse", "RegulatoryRequirement", "RegulatoryRequirementDetail", "CustomerDeadline", "ShareToken", "Status", "CreatedBy", "CreatedAt", "UpdatedAt", "TemplateType", "VendorExternalId", "VendorAddress", "VendorContactPerson", "VendorContactMobile", "VendorContactEmail", "IngredientComponentId", "ProductPolicyTag", "VendorAcceptedAt", "VendorAcceptedBy") FROM stdin;
1	SR-20260710-0001	1	2026-07-10	\N	Test User	Test Co		Test Customer	t	new	new_submission		Test Project	kg	100	10	1000			[{"name":"Test Flavour","description":"desc"}]	t	f	t	f	f	1	Kg		na	na			f	f				na		\N	49884467743c47848bcfdefe30a670e8	submitted		2026-07-10 07:55:57.204487+00	2026-07-10 07:55:57.204487+00	sample-request-flavours								\N	
\.
...
VP-RFQ1-L1-V003	V003	Artisan Dairy Co.	Chili Flakes	Dry Goods			8	{"orderUnit":"Kg","orderQty":1,"packUnit":"Bag","packQty":1,"unitUnit":"Bag","unitQty":1}		f	[]	t	2026-07-10 08:29:54.020581+00
\.
...
--
-- Name: SampleRequests_Id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."SampleRequests_Id_seq"', 1, true);
...
--
-- Name: SampleRequests PK_SampleRequests; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."SampleRequests"
    ADD CONSTRAINT "PK_SampleRequests" PRIMARY KEY ("Id");
...
--
-- Name: IX_SampleRequests_CompanyId; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_SampleRequests_CompanyId" ON public."SampleRequests" USING btree ("CompanyId");


--
-- Name: IX_SampleRequests_RequestNumber; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "IX_SampleRequests_RequestNumber" ON public."SampleRequests" USING btree ("RequestNumber");


--
-- Name: IX_SampleRequests_ShareToken; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "IX_SampleRequests_ShareToken" ON public."SampleRequests" USING btree ("ShareToken");
