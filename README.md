...
**Sister platform:** [`pulse/`](./pulse/) — **Pulse**, a standalone fitness membership ops platform (Team webapp + Admin desktop) on **PostgreSQL**. Not part of Bisync Cloud Run deploy.
