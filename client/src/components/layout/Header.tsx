      ...
      <div className="flex items-center gap-2 shrink-0">
        <div className="flex items-center gap-1.5">
          ...
          <select
            ...
            title={orgError ?? 'Companies from Admin Settings'}
          >
            <option value="" style={optionStyle}>
              {orgLoading && selectableCompanies.length === 0 ? 'Loading companies…' : 'Select Company'}
            </option>
        ...
        {(orgError || (orgLoading && selectableCompanies.length === 0)) && (
          <button
            ...
            title={orgError ?? 'Reload companies and locations'}
          >
