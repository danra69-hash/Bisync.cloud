...
export const RMS_TASK_GROUPS: RmsTaskGroup[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: 'opsExpensesAnalysis', label: 'Ops Expenses Analysis' },
    ],
  },
  {
    id: 'policies',
