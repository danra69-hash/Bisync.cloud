...
import { ensureDesktopColdStartHardReset } from './utils/desktopColdStartHardReset.ts'
...
async function boot() {
  // Desktop close → reopen must hard-reset caches so Cloud Run updates apply.
  if (await ensureDesktopColdStartHardReset()) return
